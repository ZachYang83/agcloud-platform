 ...
 * @Version: 1.0
 */
public interface AgProblemDiscernService {
     ...
     */
    void save(AgProblemDiscern agProblemDiscern, String paramType, MultipartFile[] file) throws Exception;
     ...
     * @Date 2020/9/2 11:42
     */
    List<AgProblemDiscern> findListByImgId(String imgId, String problemType);
}
