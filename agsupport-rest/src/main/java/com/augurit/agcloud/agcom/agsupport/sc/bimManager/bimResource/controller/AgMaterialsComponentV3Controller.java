 ...
 */
@RestController
@RequestMapping("/agsupport/bimResource/componentLib")
@Api(value = "材料构件相关接口", description = "材料构件相关接口")
public class AgMaterialsComponentV3Controller {
    private static final Logger logger = LoggerFactory.getLogger(AgMaterialsComponentV3Controller.class);
