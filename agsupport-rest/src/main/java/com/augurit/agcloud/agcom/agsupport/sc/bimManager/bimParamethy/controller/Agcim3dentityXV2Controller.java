...
public class Agcim3dentityXV2Controller {
    private static final Logger logger = LoggerFactory.getLogger(Agcim3dentityXV2Controller.class);
    ...
    public ContentResultForm statistics(String countKey, String groupKey, Agcim3dentityXCustom param, @RequestParam(defaultValue = "agcim3dentity_a") String tableName){
        if(StringUtils.isEmpty(countKey)){
            return new ContentResultForm(false, null, "countKey不能为空");
        }
        if(StringUtils.isEmpty(groupKey)){
