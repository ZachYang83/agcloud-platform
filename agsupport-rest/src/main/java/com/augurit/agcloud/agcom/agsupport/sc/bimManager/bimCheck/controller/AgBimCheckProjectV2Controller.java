...
@RestController
@RequestMapping("/agsupport/applicationManager/bimCheckProject")
public class AgBimCheckProjectV2Controller {
    private static final Logger logger = LoggerFactory.getLogger(AgBimCheckProjectV2Controller.class);
