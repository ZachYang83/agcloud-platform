...
@RestController
@RequestMapping("/agsupport/widgetConfig")
public class OpuFuncWidgetConfigV1Controller {
    ...
    public ContentResultForm getConfigList(String url,String code) throws Exception{
        try{
    ...
    public ContentResultForm getConfig(String url,String code,String key) throws Exception{
        try{
