 ...
 */
@RestController
@RequestMapping("/agsupport/bimResource/scheme/")
@Api(value = "用户方案设计接口", description = "用户方案设计接口")
public class AgUserDesignSchemeV3Controller {
    private static final Logger logger = LoggerFactory.getLogger(AgUserDesignSchemeV3Controller.class);
    @Autowired
