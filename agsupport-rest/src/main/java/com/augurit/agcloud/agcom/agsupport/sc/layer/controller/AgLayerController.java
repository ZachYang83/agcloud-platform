...
public class AgLayerController {
    ...
    public ContentResultForm queryVectorLayer(String dirLayerId, String userId, String where, String type, String points) {
    ...
    @ApiOperation(value = "获取图层关联的业务信息接口",notes = "获取图层关联的业务信息")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "serviceDirLayerId" ,value = "服务图层的目录图层id",dataType = "String"),
            @ApiImplicitParam(name = "relatedDirLayerId" ,value = "关联信息的目录图层id",dataType = "String"),
            @ApiImplicitParam(name = "jsonParams" ,value = "查询参数的JSON字符串",dataType = "String")
    })
    @RequestMapping(value="/getAssociatedInfo",method = RequestMethod.GET)
    public ContentResultForm getAssociatedInfo(String serviceDirLayerId,String relatedDirLayerId,String jsonParams){
        return iAgLayer.getAssociatedInfo(serviceDirLayerId,relatedDirLayerId,jsonParams);
    }
}
