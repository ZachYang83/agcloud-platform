 ...
 */
@RestController
@RequestMapping("/agsupport/BIM/materials")
@Api(value = "房屋材料接口", description = "房屋材料接口")
public class AgHouseMaterialsController {
    private static final Logger logger = LoggerFactory.getLogger(AgHouseMaterialsController.class);
