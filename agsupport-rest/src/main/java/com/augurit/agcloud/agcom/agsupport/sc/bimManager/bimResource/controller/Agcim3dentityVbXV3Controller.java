 ...
 * @tips: 把所有的前缀agcim3dentity_xxx的表查询接口合并起来
 *
 */
@RestController
@RequestMapping("/agsupport/bimResource/dentity")
@EnableSwagger2
@Api(value = "agcim3dxxx_xxx合并接口", description = "agcim3dxxx_xxx合并接口")
public class Agcim3dentityVbXV3Controller {

    private static final Logger logger = LoggerFactory.getLogger(Agcim3dentityVbXV3Controller.class);
