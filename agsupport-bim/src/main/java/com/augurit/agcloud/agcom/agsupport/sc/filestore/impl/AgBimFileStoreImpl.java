package com.augurit.agcloud.agcom.agsupport.sc.filestore.impl;
 ...
 **/
@Service
public class AgBimFileStoreImpl implements IAgBimFileStore {
    ...
    public boolean update(AgFileStore agFileStore) throws RuntimeException {
        return agFileStoreMapper.update(agFileStore) > 0;
    }
