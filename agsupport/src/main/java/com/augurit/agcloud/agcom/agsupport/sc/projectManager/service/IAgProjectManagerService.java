...
import com.augurit.agcloud.agcom.agsupport.sc.site.util.HttpRequest;
 ...
 * @Version: 1.0
 */
public interface IAgProjectManagerService {
    /**
     * @Version  1.0
     * @Author libc
     * @Description
     ...
     */
    void save(AgProjectManager agProjectManager, HttpServletRequest request) throws Exception;
