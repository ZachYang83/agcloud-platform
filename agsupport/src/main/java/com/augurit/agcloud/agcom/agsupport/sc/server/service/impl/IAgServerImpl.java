...
public class IAgServerImpl implements IAgServer {
    ...
    @Override
    @SysLog(sysName = "地图运维",funcName = "新增站点")
    ...
    @Override
    @SysLog(sysName = "地图运维",funcName = "修改站点")
    ...
    @Override
    @SysLog(sysName = "地图运维",funcName = "保存站点")
    ...
    @Override
    public AgServer selectServerBySiteName(String siteName) throws Exception {
        return agServerMapper.selectServerBySiteName(siteName);
    }

    @Override
    public void changeState(String id, String state) throws Exception {
        agServerMapper.changeState(id,state);
    }
}
