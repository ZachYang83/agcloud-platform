...
public interface IAgDir {
    ...
    /**
     * 检测同一父目录下是否已存在指定名称的子目录
     */
    boolean checkRepeatName(String parentId,String Name,String dirId) throws Exception;
     ...
     * @throws Exception
     */
    PageInfo<AgLayer> searchFromExternalLayer(String name, Page page, String userId,String status) throws Exception;
...
//    void updateDirBatch(List<AgDir> list) throws Exception;
    ...
    boolean existSameNameLayer(AgLayer agLayer) throws Exception;

    PageInfo<AgLayer> findLayerByNameAndStatus(String name,String status,Page page) throws Exception;

    void changeStatus(String ids,String status,String remoteHost) throws Exception;

    void disable(String ids,String status)throws Exception;
}
