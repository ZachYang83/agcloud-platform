...
public interface IAgParam {
     ...
     * @throws Exception
     */
    ResultForm saveMapParam(AgMapParam agMapParam) throws Exception;
     ...
     * @throws Exception
     */
    ResultForm updateMapParam(AgMapParam agMapParam) throws Exception;
     ...
     * @throws Exception
     */
    ResultForm deleteMapParamBatch(String[] ids) throws Exception;
