...
import com.augurit.agcloud.agcom.agsupport.sc.bim.service.impl.AgBimImpl;
...
public class AgBimController {

    private static Logger logger = LoggerFactory.getLogger(AgBimController.class);
    @Autowired
    private IAgBim iAgDir;
    ...
    public ModelAndView index(HttpServletRequest request, Model model) throws Exception {
        ...
        return new ModelAndView("agcloud/agcom/agsupport/bim/index");
    }
        ...
        try {
            ...
            if ((contentType != null) && (contentType.toLowerCase().startsWith("multipart/"))) {
                ...
                for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
                    ...
                    if (file.getSize() > 0) {
                        String filePath = UploadUtil.getUploadAbsolutePath()+ AgBimImpl.getLayerPictureDir();
