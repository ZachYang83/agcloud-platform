...
public class AgLaberController {
    ...
    public String getShp(HttpServletRequest request) {
        String js = "";
        try {
            String tempDirPath = request.getSession().getServletContext().getRealPath("/") + "uploads\\";
    ...
    public String getCsvCoordinates(HttpServletRequest request) {
        String js = "";
        String path = request.getSession().getServletContext().getRealPath("/") + "\\uploads\\" + request.getParameter("fileName");
        try {
