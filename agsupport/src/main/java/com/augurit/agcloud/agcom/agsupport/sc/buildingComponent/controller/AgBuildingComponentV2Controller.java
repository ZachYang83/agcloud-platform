...
public class AgBuildingComponentV2Controller {
    ...
    @ApiOperation(value = "新增构件分类信息", notes = "新增构件分类信息接口")
    @RequestMapping(value = "/add",method = RequestMethod.POST)
    public ResultForm add(AgBuildingComponent agBuildingComponent) {
        try {
            buildingComponentService.save(agBuildingComponent);
            return new ResultForm(true, "新增成功");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @ApiOperation(value = "修改构件分类信息", notes = "修改构件分类信息接口")
    @RequestMapping(value = "/update",method = RequestMethod.PUT)
    public ResultForm update(AgBuildingComponent agBuildingComponent) {
        try {
            buildingComponentService.save(agBuildingComponent);
